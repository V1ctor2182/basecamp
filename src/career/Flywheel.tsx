...
import { CheckCircle2, XCircle, RotateCcw, FileWarning, AlertTriangle, Edit3 } from 'lucide-react'
import './flywheel.css'
  ...
  return (
    <div className="c-fw-root">
      ...
      <footer className="c-fw-footer">
        ...
        <span className="c-fw-muted">Auto-refresh every 30s · m3 will add rule history + self-test report cards</span>
      </footer>
    </div>
  )
}
